...
map.on('singleclick', function (evt) {
  ...
  setTimeout(() => {
    if (false === pointClicked) {
      ...
      $('#sidebarContent').append('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSesg6d6ExJfYWm33GzVHW_TGxTW-ZmHz42fqcWNcSc_cyKe-g/viewform?usp=pp_url&entry.1998738256=' + clickedCoordinate[0] + '&entry.1387778236=' + clickedCoordinate[1] + '&entry.2072773208=' + uuidv4() + '&embedded=true" height="1200" frameborder="0" marginheight="0" marginwidth="0" style="width: 100%;">Loading…</iframe>');
