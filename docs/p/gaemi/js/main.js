...
map.on('singleclick', function (evt) {
  ...
  setTimeout(() => {
    if (false === pointClicked) {
      ...
      sidebarTitle.innerHTML = '提供新的淹水點';
      currentFeature = false;
      if (false !== previousFeature) {
        previousFeature.setStyle(pointStyleFunction(previousFeature));
      }
      $('#sidebarContent').append('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScK-urioIpamOl5EBpq8Bt0opNUhTWWU83gNhwcxy5I5ExbCg/viewform?usp=pp_url&entry.1998738256=' + clickedCoordinate[0] + '&entry.1387778236=' + clickedCoordinate[1] + '&entry.2072773208=' + uuidv4() + '&embedded=true" height="1200" frameborder="0" marginheight="0" marginwidth="0" style="width: 100%;">Loading…</iframe>');
  ...
  for (k in features) {
    ...
    if (p.id === pointId) {
      ...
      $('input#btn-update').click(function (e) {
        ...
        e.preventDefault();
        $(this).parent().html('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScK-urioIpamOl5EBpq8Bt0opNUhTWWU83gNhwcxy5I5ExbCg/viewform?usp=pp_url&entry.1998738256=' + p.longitude + '&entry.1387778236=' + p.latitude + '&entry.2072773208=' + p.id + '&embedded=true" height="1200" frameborder="0" marginheight="0" marginwidth="0" style="width: 100%;">Loading…</iframe>');
      });
    }
  }
  sidebar.open('home');
...
$.get('data/base.csv', {}, function (bc) {
  ...
  $.get('https://docs.google.com/spreadsheets/d/e/2PACX-1vRELEK5UO_xmbZ_MPSLrjQ7yTaDS38d-d5YBQJrEUMvxsqLAscR6RqIqOOjybdX4qme7L5Qk694H-7Q/pub?output=csv', {}, function (c) {
