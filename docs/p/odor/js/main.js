...
map.on('singleclick', function (evt) {
  ...
  setTimeout(() => {
    if (false === pointClicked) {
      ...
      sidebarTitle.innerHTML = '提供新的偵測點';
      currentFeature = false;
      if (false !== previousFeature) {
        previousFeature.setStyle(pointStyleFunction(previousFeature));
      }
      $('#sidebarContent').append('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfQ6gqzqEfiQjawB9oJ6FMxIExTeKtmqLvMjY1PZjPmd4oeaw/viewform?usp=pp_url&entry.1998738256=' + clickedCoordinate[0] + '&entry.1387778236=' + clickedCoordinate[1] + '&entry.2072773208=' + uuidv4() + '&embedded=true" height="1200" frameborder="0" marginheight="0" marginwidth="0" style="width: 100%;">Loading…</iframe>');
